...
{
  print_unimplimented();
  return V5_DeviceLedColor::kLedColorBlack;
}
...
{
  print_unimplimented();
  return V5_AdiPortConfiguration::kAdiPortTypeAnalogIn;
}
...
{
  print_unimplimented();
  return V5_DeviceBumperState::kBumperPressed;
}
...
{
  print_unimplimented();
  return V5MotorControlMode::kMotorControlModeOFF;
}
...
{
  print_unimplimented();
  return V5MotorEncoderUnits::kMotorEncoderCounts;
}
...
{
  print_unimplimented();
  return V5MotorBrakeMode::kV5MotorBrakeModeBrake;
}
...
{
  print_unimplimented();
  return V5VisionMode::kVisionTypeTest;
}
...
{
  print_unimplimented();
  return V5VisionWBMode::kVisionWBManual;
}
...
{
  print_unimplimented();
  return V5VisionLedMode::kVisionLedModeAuto;
}
...
{
  print_unimplimented();
  return V5VisionWifiMode::kVisionWifiModeOff;
}

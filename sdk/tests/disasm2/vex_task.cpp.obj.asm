...
00000000 <vex::task::task()>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <vexTaskGetIndex>
   c:	e3500000 	cmp	r0, #0
  10:	ba000002 	blt	20 <vex::task::task()+0x20>
...
00000000 <vex::task::task(int (*)(void*), void*)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e1a06002 	mov	r6, r2
   8:	e59f3044 	ldr	r3, [pc, #68]	; 54 <vex::task::task(int (*)(void*), void*)+0x54>
  ...
  28:	e59f1028 	ldr	r1, [pc, #40]	; 58 <vex::task::task(int (*)(void*), void*)+0x58>
...
00000000 <vex::task::task(int (*)(), long)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5841000 	str	r1, [r4]
   c:	e1a05001 	mov	r5, r1
  10:	e59f1040 	ldr	r1, [pc, #64]	; 58 <vex::task::task(int (*)(), long)+0x58>
  ...
  30:	e59f1024 	ldr	r1, [pc, #36]	; 5c <vex::task::task(int (*)(), long)+0x5c>
  34:	ebfffffe 	bl	0 <vex_sprintf>
  38:	e1a00005 	mov	r0, r5
  3c:	e3a01002 	mov	r1, #2
  40:	e1a0200d 	mov	r2, sp
...
00000000 <vex::task::task(int (*)(void*), void*, long)>:
   0:	e92d40f0 	push	{r4, r5, r6, r7, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5841000 	str	r1, [r4]
   c:	e1a05001 	mov	r5, r1
  10:	e59f1048 	ldr	r1, [pc, #72]	; 60 <vex::task::task(int (*)(void*), void*, long)+0x60>
  14:	e1a06002 	mov	r6, r2
  ...
  28:	e2823001 	add	r3, r2, #1
  2c:	e5813000 	str	r3, [r1]
  30:	e59f102c 	ldr	r1, [pc, #44]	; 64 <vex::task::task(int (*)(void*), void*, long)+0x64>
  34:	ebfffffe 	bl	0 <vex_sprintf>
...
00000000 <vex::task::stop(vex::task const&)>:
...
00000000 <vex::task::suspend(vex::task const&)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
   8:	e3500000 	cmp	r0, #0
   c:	012fff1e 	bxeq	lr
...
00000000 <vex::task::resume(vex::task const&)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
   8:	e3500000 	cmp	r0, #0
   c:	012fff1e 	bxeq	lr
...
00000000 <vex::task::priority(vex::task const&)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
   8:	e3500000 	cmp	r0, #0
   c:	012fff1e 	bxeq	lr
...
00000000 <vex::task::setPriority(vex::task const&, long)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
   8:	e3500000 	cmp	r0, #0
   c:	012fff1e 	bxeq	lr
...
00000000 <vex::task::stop(void*, int)>:
...
00000000 <vex::task::stopAll()>:
   0:	e92d4073 	push	{r0, r1, r4, r5, r6, lr}
   4:	e59f007c 	ldr	r0, [pc, #124]	; 88 <vex::task::stopAll()+0x88>
   8:	e3500000 	cmp	r0, #0
   c:	0a00001b 	beq	80 <vex::task::stopAll()+0x80>
...
00000000 <vex::task::setPriority(long)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
...
00000000 <vex::task::_stopAll()>:
   0:	e92d4010 	push	{r4, lr}
   4:	e59f4028 	ldr	r4, [pc, #40]	; 34 <vex::task::_stopAll()+0x34>
   8:	e3540000 	cmp	r4, #0
   c:	08bd8010 	popeq	{r4, pc}
  10:	ebfffffe 	bl	0 <vexSystemVersion>
  14:	e59f301c 	ldr	r3, [pc, #28]	; 38 <vex::task::_stopAll()+0x38>
...
00000000 <vex::task::_dump()>:
   0:	eafffffe 	b	0 <vexTasksDump>

Disassembly of section .text._ZN3vex9semaphoreC2Ev:

00000000 <vex::semaphore::semaphore()>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e59f5020 	ldr	r5, [pc, #32]	; 30 <vex::semaphore::semaphore()+0x30>
   c:	e5d53000 	ldrb	r3, [r5]
  10:	e3530000 	cmp	r3, #0
  14:	1a000003 	bne	28 <vex::semaphore::semaphore()+0x28>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::task::stopAll()+0x80a5e0>

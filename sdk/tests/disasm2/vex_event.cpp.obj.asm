...
00000000 <vex::event::event(unsigned long, unsigned long, void (*)())>:
...
00000000 <vex::event::event(void (*)())>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e59f5028 	ldr	r5, [pc, #40]	; 38 <vex::event::event(void (*)())+0x38>
...
00000000 <vex::event::event(void (*)(void*), void*)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a0c001 	mov	ip, r1
   8:	e59f5030 	ldr	r5, [pc, #48]	; 40 <vex::event::event(void (*)(void*), void*)+0x40>
...
00000000 <vex::event::event(vex::event, void (*)())>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5802000 	str	r2, [r0]
   c:	e5910004 	ldr	r0, [r1, #4]
  10:	e3500000 	cmp	r0, #0
  14:	da000001 	ble	20 <vex::event::event(vex::event, void (*)())+0x20>
...
00000000 <vex::event::event(vex::event, void (*)(void*), void*)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5802000 	str	r2, [r0]
   c:	e5910004 	ldr	r0, [r1, #4]
  10:	e3500000 	cmp	r0, #0
  14:	da000001 	ble	20 <vex::event::event(vex::event, void (*)(void*), void*)+0x20>
  18:	e3a01000 	mov	r1, #0
...
00000000 <vex::event::set(void (*)())>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5900004 	ldr	r0, [r0, #4]
   c:	e1a02001 	mov	r2, r1
  10:	e3500000 	cmp	r0, #0
  14:	da000002 	ble	24 <vex::event::set(void (*)())+0x24>
  18:	e3a01000 	mov	r1, #0
  1c:	e8bd4070 	pop	{r4, r5, r6, lr}
  20:	eafffffe 	b	0 <vexEventAdd>
  24:	e59f6024 	ldr	r6, [pc, #36]	; 50 <vex::event::set(void (*)())+0x50>
...
00000000 <vex::event::operator()(void (*)())>:
   0:	eafffffe 	b	0 <vex::event::operator()(void (*)())>

Disassembly of section .text._ZN3vex5event4initEmmPFvvE:

00000000 <vex::event::init(unsigned long, unsigned long, void (*)())>:
   0:	eafffffe 	b	0 <vexEventAdd>

Disassembly of section .text._ZN3vex5event4initEmmPFviE:

00000000 <vex::event::init(unsigned long, unsigned long, void (*)(int))>:
...
00000000 <vex::event::broadcastAndWait(long)>:
   0:	e5900004 	ldr	r0, [r0, #4]
   4:	e3500000 	cmp	r0, #0
   8:	d12fff1e 	bxle	lr
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::event::set(void (*)())+0x80a5e0>

...
00000000 <vex::optical::~optical()>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <vex::optical::~optical()+0x1c>
...
00000000 <vex::optical::~optical()>:
   ...
   8:	ebfffffe 	bl	0 <vex::optical::~optical()>
...
00000000 <vex::optical::installed()>:
...
00000000 <vex::optical::brightness(bool)>:
   0:	e92d4010 	push	{r4, lr}
  ...
  18:	1a000005 	bne	34 <vex::optical::brightness(bool)+0x34>
  1c:	eddf1b07 	vldr	d17, [pc, #28]	; 40 <vex::optical::brightness(bool)+0x40>
  20:	ee600ba1 	vmul.f64	d16, d16, d17
  24:	eddf1b07 	vldr	d17, [pc, #28]	; 48 <vex::optical::brightness(bool)+0x48>
...
00000000 <vex::optical::isNearObject()>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <vex::optical::setLight(vex::ledState)>:
   0:	e3510001 	cmp	r1, #1
...
00000000 <vex::optical::setLightPower(long, vex::percentUnits)>:
   0:	e3510000 	cmp	r1, #0
   4:	b3a01000 	movlt	r1, #0
   8:	ba000005 	blt	24 <vex::optical::setLightPower(long, vex::percentUnits)+0x24>
   c:	e3510064 	cmp	r1, #100	; 0x64
  10:	c3a01064 	movgt	r1, #100	; 0x64
  14:	ca000001 	bgt	20 <vex::optical::setLightPower(long, vex::percentUnits)+0x20>
  18:	e3510000 	cmp	r1, #0
  1c:	0a000000 	beq	24 <vex::optical::setLightPower(long, vex::percentUnits)+0x24>
...
00000000 <vex::optical::objectDetectThreshold(long)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <vex::optical::objectDetected(void (*)())>:
...
00000000 <vex::optical::objectLost(void (*)())>:
   0:	e1a02001 	mov	r2, r1
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	e3a01002 	mov	r1, #2
   c:	eafffffe 	b	0 <vex::event::init(unsigned long, unsigned long, void (*)())>
...
00000000 <vex::optical::optical(long, bool)>:
  ...
  38:	0a000001 	beq	44 <vex::optical::optical(long, bool)+0x44>
  3c:	ebfffffe 	bl	0 <vex::optical::optical(long, bool)>
  40:	ea000000 	b	48 <vex::optical::optical(long, bool)+0x48>
  44:	ebfffffe 	bl	0 <vex::optical::optical(long, bool)>
...
00000000 <vex::optical::gesture::gesture()>:
...
00000000 <vex::optical::getGesture()>:
  ...
  14:	e1a00004 	mov	r0, r4
  18:	ebfffffe 	bl	0 <vex::optical::getGesture()>
  ...
  54:	ea000003 	b	68 <vex::optical::getGesture()+0x68>
  ...
  6c:	ea000006 	b	8c <vex::optical::getGesture()+0x8c>
  70:	e3a03001 	mov	r3, #1
  74:	ea000004 	b	8c <vex::optical::getGesture()+0x8c>
  78:	e3a03002 	mov	r3, #2
  7c:	ea000002 	b	8c <vex::optical::getGesture()+0x8c>
  80:	e3a03004 	mov	r3, #4
  84:	ea000000 	b	8c <vex::optical::getGesture()+0x8c>
...
00000000 <vex::optical::getRgb(bool)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e3520000 	cmp	r2, #0
  ...
  34:	0a000011 	beq	80 <vex::optical::getRgb(bool)+0x80>
  ...
  7c:	ea000008 	b	a4 <vex::optical::getRgb(bool)+0xa4>
...
00000000 <vex::optical::gestureDown(void (*)())>:
   0:	e1a02001 	mov	r2, r1
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	e3a01008 	mov	r1, #8
   c:	eafffffe 	b	0 <vex::event::init(unsigned long, unsigned long, void (*)())>
...
00000000 <vex::optical::gestureLeft(void (*)())>:
   0:	e1a02001 	mov	r2, r1
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <vex::optical::gestureRight(void (*)())>:
   0:	e1a02001 	mov	r2, r1
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <vtable for vex::optical>:
	...
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::optical::color()+0x80a5e0>

...
00000000 <vex::device::~device()>:
   0:	e12fff1e 	bx	lr

Disassembly of section .text._ZN3vex6device5valueEv:

00000000 <vex::device::value()>:
   0:	e3a00000 	mov	r0, #0
   4:	e12fff1e 	bx	lr
...
00000000 <vex::device::device()>:
   0:	e59f3018 	ldr	r3, [pc, #24]	; 20 <vex::device::device()+0x20>
   4:	e3a01000 	mov	r1, #0
   8:	e92d4010 	push	{r4, lr}
   c:	e1a04000 	mov	r4, r0
  10:	e5803000 	str	r3, [r0]
  14:	ebfffffe 	bl	0 <vex::device::device()>
...
00000000 <vex::device::device(long)>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <vex::device::device(long)+0x1c>
   4:	e92d4010 	push	{r4, lr}
   8:	e1a04000 	mov	r4, r0
   c:	e5803000 	str	r3, [r0]
  10:	ebfffffe 	bl	0 <vex::device::device(long)>
...
00000000 <vex::device::installed()>:
   0:	e92d4008 	push	{r3, lr}
   4:	ebfffffe 	bl	0 <vex::device::installed()>
...
00000000 <vex::devices::devices()>:
  ...
  20:	ebfffffe 	bl	0 <vex::devices::devices()>
  24:	e1550007 	cmp	r5, r7
  28:	1afffffa 	bne	18 <vex::devices::devices()+0x18>
  2c:	e1a00007 	mov	r0, r7
  30:	e3a05000 	mov	r5, #0
  34:	ebfffffe 	bl	0 <vex::devices::devices()>
  38:	e3a03020 	mov	r3, #32
  3c:	e1a0000d 	mov	r0, sp
  40:	e5843000 	str	r3, [r4]
  44:	e3a01000 	mov	r1, #0
  48:	ebfffffe 	bl	0 <vex::devices::devices()>
  ...
  7c:	ebfffffe 	bl	0 <vex::devices::devices()>
  80:	e3550020 	cmp	r5, #32
  84:	e2866010 	add	r6, r6, #16
  88:	1afffff5 	bne	64 <vex::devices::devices()+0x64>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::devices::devices()+0x80a5e0>

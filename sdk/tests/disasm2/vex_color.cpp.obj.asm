...
00000000 <vex::color::color(unsigned char, unsigned char, unsigned char)>:
...
00000000 <vex::color::color(int, bool)>:
...
00000000 <vex::color::rgb(unsigned long)>:
   0:	e5801000 	str	r1, [r0]
   4:	e3a03000 	mov	r3, #0
...
00000000 <vex::color::rgb(unsigned char, unsigned char, unsigned char)>:
   0:	e1a02402 	lsl	r2, r2, #8
   4:	e0821801 	add	r1, r2, r1, lsl #16
   8:	e3a02000 	mov	r2, #0
...
00000000 <vex::color::hsv(unsigned long, double, double)>:
  ...
  30:	ed9f7b3e 	vldr	d7, [pc, #248]	; 130 <vex::color::hsv(unsigned long, double, double)+0x130>
  ...
  b0:	ea000014 	b	108 <vex::color::hsv(unsigned long, double, double)+0x108>
  ...
  d0:	ea00000f 	b	114 <vex::color::hsv(unsigned long, double, double)+0x114>
  d4:	e0803403 	add	r3, r0, r3, lsl #8
  d8:	e0833801 	add	r3, r3, r1, lsl #16
  dc:	ea00000c 	b	114 <vex::color::hsv(unsigned long, double, double)+0x114>
  e0:	e1a01403 	lsl	r1, r3, #8
  e4:	e0812800 	add	r2, r1, r0, lsl #16
  e8:	e082300c 	add	r3, r2, ip
  ec:	ea000008 	b	114 <vex::color::hsv(unsigned long, double, double)+0x114>
  f0:	e0833800 	add	r3, r3, r0, lsl #16
  f4:	e0833401 	add	r3, r3, r1, lsl #8
  f8:	ea000005 	b	114 <vex::color::hsv(unsigned long, double, double)+0x114>
  fc:	e0833400 	add	r3, r3, r0, lsl #8
 100:	e083380c 	add	r3, r3, ip, lsl #16
 104:	ea000002 	b	114 <vex::color::hsv(unsigned long, double, double)+0x114>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::color::hsv(unsigned long, double, double)+0x80a5e0>

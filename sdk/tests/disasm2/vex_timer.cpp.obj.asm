...
00000000 <vex::timer::operator unsigned long() const>:
   0:	eafffffe 	b	0 <vex::timer::operator unsigned long() const>

Disassembly of section .text._ZNK3vex5timer4timeENS_9timeUnitsE:

00000000 <vex::timer::time(vex::timeUnits) const>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
  ...
  1c:	0ddf1b05 	vldreq	d17, [pc, #20]	; 38 <vex::timer::time(vex::timeUnits) const+0x38>
...
00000000 <vex::timer::event(void (*)(), unsigned long)>:
   0:	e1a03000 	mov	r3, r0
   4:	e1a02001 	mov	r2, r1
   8:	e3e00000 	mvn	r0, #0
   c:	e1a01003 	mov	r1, r3
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::timer::time(vex::timeUnits) const+0x80a5e0>

...
00000000 <vex::distance::~distance()>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <vex::distance::~distance()+0x1c>
...
00000000 <vex::distance::~distance()>:
   ...
   8:	ebfffffe 	bl	0 <vex::distance::~distance()>
...
00000000 <vex::distance::installed()>:
...
00000000 <vex::distance::objectDistance(vex::distanceUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	ebfffffe 	bl	0 <vexDistanceDistanceGet>
  10:	e3540001 	cmp	r4, #1
  14:	0ddf1b09 	vldreq	d17, [pc, #36]	; 40 <vex::distance::objectDistance(vex::distanceUnits)+0x40>
  18:	ee070a90 	vmov	s15, r0
  1c:	eef80b67 	vcvt.f64.u32	d16, s15
  20:	0a000002 	beq	30 <vex::distance::objectDistance(vex::distanceUnits)+0x30>
  24:	e3540002 	cmp	r4, #2
  28:	1a000001 	bne	34 <vex::distance::objectDistance(vex::distanceUnits)+0x34>
...
00000000 <vex::distance::objectSize()>:
   0:	e92d4008 	push	{r3, lr}
  ...
  18:	da000003 	ble	2c <vex::distance::objectSize()+0x2c>
...
00000000 <vex::distance::isObjectDetected()>:
  ...
  24:	eddf0b13 	vldr	d16, [pc, #76]	; 78 <vex::distance::isObjectDetected()+0x78>
  ...
  50:	1a000006 	bne	70 <vex::distance::isObjectDetected()+0x70>
...
00000000 <vex::distance::changed(void (*)())>:
...
00000000 <vtable for vex::distance>:
	...
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::distance::isObjectDetected()+0x80a5e0>

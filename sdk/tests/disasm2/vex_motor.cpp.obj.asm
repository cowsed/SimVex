...
00000000 <vex::motor::~motor()>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <vex::motor::~motor()+0x1c>
...
00000000 <vex::motor::~motor()>:
   ...
   8:	ebfffffe 	bl	0 <vex::motor::~motor()>
...
00000000 <vex::motor::setReversed(bool)>:
...
00000000 <vex::motor::defaultStopping(vex::brakeType)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5903018 	ldr	r3, [r0, #24]
   c:	e1a05001 	mov	r5, r1
  10:	e1510003 	cmp	r1, r3
  14:	0a000003 	beq	28 <vex::motor::defaultStopping(vex::brakeType)+0x28>
...
00000000 <vex::motor::setBrake(vex::brakeType)>:
   0:	eafffffe 	b	0 <vex::motor::setBrake(vex::brakeType)>

Disassembly of section .text._ZN3vex5motor11setStoppingENS_9brakeTypeE:

00000000 <vex::motor::setStopping(vex::brakeType)>:
   0:	eafffffe 	b	0 <vex::motor::setStopping(vex::brakeType)>

Disassembly of section .text._ZN3vex5motorC2El:

00000000 <vex::motor::motor(long)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <vex::device::device(long)>
   c:	e59f305c 	ldr	r3, [pc, #92]	; 70 <vex::motor::motor(long)+0x70>
  ...
  28:	e59f3044 	ldr	r3, [pc, #68]	; 74 <vex::motor::motor(long)+0x74>
  2c:	e5933000 	ldr	r3, [r3]
  30:	e5843014 	str	r3, [r4, #20]
  34:	e3a03003 	mov	r3, #3
  38:	e5843018 	str	r3, [r4, #24]
  3c:	e584301c 	str	r3, [r4, #28]
  40:	ebfffffe 	bl	0 <vex::motor::motor(long)>
  44:	e1500005 	cmp	r0, r5
  48:	0a000006 	beq	68 <vex::motor::motor(long)+0x68>
  ...
  64:	ebfffffe 	bl	0 <vex::motor::motor(long)>
...
00000000 <vex::motor::motor(long, vex::gearSetting, bool)>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e1a06003 	mov	r6, r3
   c:	e1a05002 	mov	r5, r2
  10:	ebfffffe 	bl	0 <vex::motor::motor(long, vex::gearSetting, bool)>
...
00000000 <vex::motor::motor(long, vex::gearSetting)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e1a05002 	mov	r5, r2
   c:	ebfffffe 	bl	0 <vex::motor::motor(long, vex::gearSetting)>
...
00000000 <vex::motor::motor(long, bool)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e1a05002 	mov	r5, r2
   c:	ebfffffe 	bl	0 <vex::motor::motor(long, bool)>
  10:	e5940008 	ldr	r0, [r4, #8]
...
00000000 <vex::motor::setTimeout(long, vex::timeUnits)>:
   0:	e16f2f12 	clz	r2, r2
   4:	e3510000 	cmp	r1, #0
   8:	e1a022a2 	lsr	r2, r2, #5
   c:	d3a02000 	movle	r2, #0
  10:	e3520000 	cmp	r2, #0
  14:	0a000005 	beq	30 <vex::motor::setTimeout(long, vex::timeUnits)+0x30>
  18:	e59f3028 	ldr	r3, [pc, #40]	; 48 <vex::motor::setTimeout(long, vex::timeUnits)+0x48>
  1c:	e1510003 	cmp	r1, r3
  20:	a1a01003 	movge	r1, r3
  24:	e3a03ffa 	mov	r3, #1000	; 0x3e8
  28:	e0010193 	mul	r1, r3, r1
  2c:	ea000003 	b	40 <vex::motor::setTimeout(long, vex::timeUnits)+0x40>
...
00000000 <vex::motor::spin(vex::directionType, double, vex::voltageUnits)>:
  ...
  18:	0ddf1b0a 	vldreq	d17, [pc, #40]	; 48 <vex::motor::spin(vex::directionType, double, vex::voltageUnits)+0x48>
...
00000000 <vex::motor::isSpinningMode()>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
...
00000000 <vex::motor::isSpinning()>:
  ...
  18:	0a000007 	beq	3c <vex::motor::isSpinning()+0x3c>
  1c:	e5940008 	ldr	r0, [r4, #8]
  20:	ebfffffe 	bl	0 <vexMotorZeroPositionFlagGet>
  24:	e3500000 	cmp	r0, #0
  28:	1a000003 	bne	3c <vex::motor::isSpinning()+0x3c>
  2c:	e1a00004 	mov	r0, r4
  30:	ebfffffe 	bl	0 <vex::motor::isSpinning()>
...
00000000 <vex::motor::isDone()>:
   0:	e92d4008 	push	{r3, lr}
   4:	ebfffffe 	bl	0 <vex::motor::isDone()>
...
00000000 <vex::motor::stop(vex::brakeType)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
  ...
  20:	ebfffffe 	bl	0 <vex::motor::stop(vex::brakeType)>
...
00000000 <vex::motor::stop()>:
   0:	e590101c 	ldr	r1, [r0, #28]
   4:	eafffffe 	b	0 <vex::motor::stop()>

Disassembly of section .text._ZN3vex5motor12setMaxTorqueEdNS_12percentUnitsE:

00000000 <vex::motor::setMaxTorque(double, vex::percentUnits)>:
   0:	ec432b30 	vmov	d16, r2, r3
   4:	eef50bc0 	vcmpe.f64	d16, #0.0
   8:	eddf1b12 	vldr	d17, [pc, #72]	; 58 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x58>
   c:	eef1fa10 	vmrs	APSR_nzcv, fpscr
  10:	4ddf0b12 	vldrmi	d16, [pc, #72]	; 60 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x60>
  14:	4a000002 	bmi	24 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x24>
  ...
  2c:	eddf1b0d 	vldr	d17, [pc, #52]	; 68 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x68>
  30:	ee600ba1 	vmul.f64	d16, d16, d17
  34:	eddf1b0d 	vldr	d17, [pc, #52]	; 70 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x70>
  38:	eec00ba1 	vdiv.f64	d16, d16, d17
  3c:	eddf1b0d 	vldr	d17, [pc, #52]	; 78 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x78>
  40:	ee700ba1 	vadd.f64	d16, d16, d17
  44:	eddf1b0d 	vldr	d17, [pc, #52]	; 80 <vex::motor::setMaxTorque(double, vex::percentUnits)+0x80>
  ...
  78:	6a7ef9db 	bvs	1fbe7ec <vex::motor::setMaxTorque(double, vex::percentUnits)+0x1fbe7ec>
...
00000000 <vex::motor::setMaxTorque(double, vex::torqueUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ed2d8b02 	vpush	{d8}
   c:	e5900008 	ldr	r0, [r0, #8]
  ...
  18:	e3530001 	cmp	r3, #1
  1c:	0ddf0b1b 	vldreq	d16, [pc, #108]	; 90 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0x90>
  20:	0e888b20 	vdiveq.f64	d8, d8, d16
  24:	ebfffffe 	bl	0 <vexMotorGearingGet>
  28:	e3500001 	cmp	r0, #1
  2c:	0e388b08 	vaddeq.f64	d8, d8, d8
  30:	0a000002 	beq	40 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0x40>
  ...
  48:	4d9f8b12 	vldrmi	d8, [pc, #72]	; 98 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0x98>
  4c:	4a000003 	bmi	60 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0x60>
  50:	eddf0b12 	vldr	d16, [pc, #72]	; a0 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0xa0>
  54:	eeb48b60 	vcmp.f64	d8, d16
  58:	eef1fa10 	vmrs	APSR_nzcv, fpscr
  5c:	ceb08b60 	vmovgt.f64	d8, d16
  60:	eddf0b10 	vldr	d16, [pc, #64]	; a8 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0xa8>
  64:	e5940008 	ldr	r0, [r4, #8]
  68:	ee888b20 	vdiv.f64	d8, d8, d16
  6c:	eddf0b0f 	vldr	d16, [pc, #60]	; b0 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0xb0>
  70:	ee388b20 	vadd.f64	d8, d8, d16
  74:	eddf0b0f 	vldr	d16, [pc, #60]	; b8 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0xb8>
  ...
  b0:	6a7ef9db 	bvs	1fbe824 <vex::motor::setMaxTorque(double, vex::torqueUnits)+0x1fbe824>
...
00000000 <vex::motor::setMaxTorque(double, vex::currentUnits)>:
   0:	eddf0b06 	vldr	d16, [pc, #24]	; 20 <vex::motor::setMaxTorque(double, vex::currentUnits)+0x20>
...
00000000 <vex::motor::torqueToCurrent(double)>:
   0:	eddf0b06 	vldr	d16, [pc, #24]	; 20 <vex::motor::torqueToCurrent(double)+0x20>
   4:	ec432b31 	vmov	d17, r2, r3
   8:	eec10ba0 	vdiv.f64	d16, d17, d16
   c:	eddf1b05 	vldr	d17, [pc, #20]	; 28 <vex::motor::torqueToCurrent(double)+0x28>
  ...
  28:	6a7ef9db 	bvs	1fbe79c <vex::motor::torqueToCurrent(double)+0x1fbe79c>
  2c:	3fc374bc 	svccc	0x00c374bc

Disassembly of section .text._ZN3vex5motor9directionEv:

00000000 <vex::motor::direction()>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	ebfffffe 	bl	0 <vexMotorDirectionGet>
   c:	e3700001 	cmn	r0, #1
  10:	0a000003 	beq	24 <vex::motor::direction()+0x24>
...
00000000 <vex::motor::current(vex::currentUnits)>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	ebfffffe 	bl	0 <vexMotorCurrentGet>
   c:	eddf0b05 	vldr	d16, [pc, #20]	; 28 <vex::motor::current(vex::currentUnits)+0x28>
...
00000000 <vex::motor::current(vex::percentUnits)>:
   0:	e92d4008 	push	{r3, lr}
   4:	e3a01000 	mov	r1, #0
   8:	ebfffffe 	bl	0 <vex::motor::current(vex::percentUnits)>
   c:	eddf1b09 	vldr	d17, [pc, #36]	; 38 <vex::motor::current(vex::percentUnits)+0x38>
...
00000000 <vex::motor::voltage(vex::voltageUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	ebfffffe 	bl	0 <vexMotorVoltageGet>
  10:	e59f3028 	ldr	r3, [pc, #40]	; 40 <vex::motor::voltage(vex::voltageUnits)+0x40>
  14:	e5933000 	ldr	r3, [r3]
  18:	e1540003 	cmp	r4, r3
  1c:	0ddf1b05 	vldreq	d17, [pc, #20]	; 38 <vex::motor::voltage(vex::voltageUnits)+0x38>
...
00000000 <vex::motor::temperature(vex::percentUnits)>:
  ...
  18:	eddf1b0c 	vldr	d17, [pc, #48]	; 50 <vex::motor::temperature(vex::percentUnits)+0x50>
  1c:	eec00ba1 	vdiv.f64	d16, d16, d17
  20:	eddf1b0c 	vldr	d17, [pc, #48]	; 58 <vex::motor::temperature(vex::percentUnits)+0x58>
  24:	ee600ba1 	vmul.f64	d16, d16, d17
  28:	eef50bc0 	vcmpe.f64	d16, #0.0
  2c:	eef1fa10 	vmrs	APSR_nzcv, fpscr
  30:	4ddf0b0a 	vldrmi	d16, [pc, #40]	; 60 <vex::motor::temperature(vex::percentUnits)+0x60>
  34:	4a000002 	bmi	44 <vex::motor::temperature(vex::percentUnits)+0x44>
...
00000000 <vex::motor::temperature(vex::temperatureUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	ebfffffe 	bl	0 <vexMotorTemperatureGet>
  10:	e3540001 	cmp	r4, #1
  14:	0ddf1b05 	vldreq	d17, [pc, #20]	; 30 <vex::motor::temperature(vex::temperatureUnits)+0x30>
  18:	0ddf2b06 	vldreq	d18, [pc, #24]	; 38 <vex::motor::temperature(vex::temperatureUnits)+0x38>
...
00000000 <vex::motor::getMotorType()>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <vex::device::type()>
   c:	e3500002 	cmp	r0, #2
  10:	1a000003 	bne	24 <vex::motor::getMotorType()+0x24>
  14:	e1a00004 	mov	r0, r4
  18:	ebfffffe 	bl	0 <vex::device::flags()>
...
00000000 <vex::motor::velocityToScaled(double, vex::velocityUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	ed2d8b02 	vpush	{d8}
  ...
  20:	0a000002 	beq	30 <vex::motor::velocityToScaled(double, vex::velocityUnits)+0x30>
  ...
  40:	0a000002 	beq	50 <vex::motor::velocityToScaled(double, vex::velocityUnits)+0x50>
...
00000000 <vex::motor::getVelocity(vex::velocityUnits)>:
  ...
  18:	ebfffffe 	bl	0 <vex::motor::getVelocity(vex::velocityUnits)>
...
00000000 <vex::motor::velocity(vex::velocityUnits)>:
  ...
  24:	ebfffffe 	bl	0 <vex::motor::velocity(vex::velocityUnits)>
  28:	e28dd00c 	add	sp, sp, #12
  2c:	e8bd8030 	pop	{r4, r5, pc}

Disassembly of section .text._ZN3vex5motor5valueEv:

00000000 <vex::motor::value()>:
   0:	e92d4008 	push	{r3, lr}
   4:	e3a01000 	mov	r1, #0
   8:	ebfffffe 	bl	0 <vex::motor::value()>
...
00000000 <vex::motor::command(vex::velocityUnits)>:
   0:	e92d4037 	push	{r0, r1, r2, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	e1a05001 	mov	r5, r1
  ...
  28:	ebfffffe 	bl	0 <vex::motor::command(vex::velocityUnits)>
...
00000000 <vex::motor::scaledToVelocity(double, vex::velocityUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	ed2d8b02 	vpush	{d8}
   c:	e59d4010 	ldr	r4, [sp, #16]
  ...
  20:	0a000002 	beq	30 <vex::motor::scaledToVelocity(double, vex::velocityUnits)+0x30>
  24:	e3500002 	cmp	r0, #2
  ...
  38:	0ef80be7 	vcvteq.f64.s32	d16, s15
  3c:	0e288b20 	vmuleq.f64	d8, d8, d16
  40:	0a000002 	beq	50 <vex::motor::scaledToVelocity(double, vex::velocityUnits)+0x50>
  44:	e3540002 	cmp	r4, #2
  48:	0ef10b08 	vmoveq.f64	d16, #24	; 0x40c00000  6.0
  ...
  80:	da000003 	ble	94 <vex::motor::scaledToVelocity(double, vex::velocityUnits)+0x94>
...
00000000 <vex::motor::spin(vex::directionType, double, vex::velocityUnits)>:
   0:	e92d4073 	push	{r0, r1, r4, r5, r6, lr}
   4:	e1a06001 	mov	r6, r1
   8:	e59d1018 	ldr	r1, [sp, #24]
   c:	e1a04000 	mov	r4, r0
  10:	e58d1000 	str	r1, [sp]
  14:	ebfffffe 	bl	0 <vex::motor::spin(vex::directionType, double, vex::velocityUnits)>
  ...
  3c:	1a000002 	bne	4c <vex::motor::spin(vex::directionType, double, vex::velocityUnits)+0x4c>
  40:	e1a00004 	mov	r0, r4
  44:	e594101c 	ldr	r1, [r4, #28]
  48:	ebfffffe 	bl	0 <vex::motor::spin(vex::directionType, double, vex::velocityUnits)>
...
00000000 <vex::motor::spin(vex::directionType)>:
   0:	e92d4007 	push	{r0, r1, r2, lr}
   4:	e3a03001 	mov	r3, #1
  ...
  1c:	ebfffffe 	bl	0 <vex::motor::spin(vex::directionType)>
...
00000000 <vex::motor::spinFor(double, vex::timeUnits, double, vex::velocityUnits)>:
   0:	e92d4010 	push	{r4, lr}
   4:	ec432b30 	vmov	d16, r2, r3
   8:	ed2d8b02 	vpush	{d8}
  ...
  14:	e3530000 	cmp	r3, #0
  18:	0ddf1b14 	vldreq	d17, [pc, #80]	; 70 <vex::motor::spinFor(double, vex::timeUnits, double, vex::velocityUnits)+0x70>
  1c:	0e600ba1 	vmuleq.f64	d16, d16, d17
  20:	eebd8be0 	vcvt.s32.f64	s16, d16
  24:	ee183a10 	vmov	r3, s16
  28:	e3530000 	cmp	r3, #0
  2c:	d3a00000 	movle	r0, #0
  30:	da00000a 	ble	60 <vex::motor::spinFor(double, vex::timeUnits, double, vex::velocityUnits)+0x60>
  34:	e59d3028 	ldr	r3, [sp, #40]	; 0x28
  38:	e3a01000 	mov	r1, #0
  3c:	e1a04000 	mov	r4, r0
  40:	e58d3000 	str	r3, [sp]
  44:	e1cd22d0 	ldrd	r2, [sp, #32]
  48:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::timeUnits, double, vex::velocityUnits)>
  4c:	ee180a10 	vmov	r0, s16
  50:	ebfffffe 	bl	0 <vexTaskSleep>
  54:	e1a00004 	mov	r0, r4
  58:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::timeUnits, double, vex::velocityUnits)>
...
00000000 <vex::motor::spinFor(vex::directionType, double, vex::timeUnits, double, vex::velocityUnits)>:
  ...
  28:	eafffffe 	b	0 <vex::motor::spinFor(vex::directionType, double, vex::timeUnits, double, vex::velocityUnits)>

Disassembly of section .text._ZN3vex5motor7spinForEdNS_9timeUnitsE:

00000000 <vex::motor::spinFor(double, vex::timeUnits)>:
  ...
  20:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::timeUnits)>
...
00000000 <vex::motor::spinFor(vex::directionType, double, vex::timeUnits)>:
  ...
  38:	ebfffffe 	bl	0 <vex::motor::spinFor(vex::directionType, double, vex::timeUnits)>
...
00000000 <vex::motor::setVelocity(double, vex::velocityUnits)>:
  ...
  14:	e58d5000 	str	r5, [sp]
  18:	ebfffffe 	bl	0 <vex::motor::setVelocity(double, vex::velocityUnits)>
  1c:	e5d43020 	ldrb	r3, [r4, #32]
  20:	e3530000 	cmp	r3, #0
  24:	e5840014 	str	r0, [r4, #20]
  28:	0a000007 	beq	4c <vex::motor::setVelocity(double, vex::velocityUnits)+0x4c>
  ...
  48:	eafffffe 	b	0 <vex::motor::setVelocity(double, vex::velocityUnits)>
...
00000000 <vex::motor::setRotationUnits(vex::rotationUnits)>:
   0:	e3510001 	cmp	r1, #1
   4:	e5900008 	ldr	r0, [r0, #8]
   8:	0a000002 	beq	18 <vex::motor::setRotationUnits(vex::rotationUnits)+0x18>
...
00000000 <vex::motor::setPosition(double, vex::rotationUnits)>:
  ...
  24:	ebfffffe 	bl	0 <vex::motor::setPosition(double, vex::rotationUnits)>
...
00000000 <vex::motor::resetPosition()>:
   0:	e92d4007 	push	{r0, r1, r2, lr}
   4:	e3a03063 	mov	r3, #99	; 0x63
   8:	e3a02000 	mov	r2, #0
   c:	e58d3000 	str	r3, [sp]
  10:	e3a03000 	mov	r3, #0
  14:	ebfffffe 	bl	0 <vex::motor::resetPosition()>
...
00000000 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>:
   0:	e92d40f7 	push	{r0, r1, r2, r4, r5, r6, r7, lr}
  ...
  1c:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  20:	e1a04000 	mov	r4, r0
  24:	e3a00001 	mov	r0, #1
  28:	ebfffffe 	bl	0 <vexCriticalSection>
  2c:	e59d1020 	ldr	r1, [sp, #32]
  30:	e1a00005 	mov	r0, r5
  34:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  ...
  6c:	1a000001 	bne	78 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x78>
  70:	e3a00000 	mov	r0, #0
  74:	ea000017 	b	d8 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xd8>
  78:	e5956010 	ldr	r6, [r5, #16]
  7c:	e1e03006 	mvn	r3, r6
  80:	e1a03fa3 	lsr	r3, r3, #31
  84:	e1540003 	cmp	r4, r3
  88:	2a00000a 	bcs	b8 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xb8>
  ...
  a4:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  a8:	e3500000 	cmp	r0, #0
  ac:	0affffef 	beq	70 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x70>
  b0:	e246600a 	sub	r6, r6, #10
  b4:	eafffff0 	b	7c <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x7c>
  b8:	e3540000 	cmp	r4, #0
  bc:	1a000001 	bne	c8 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xc8>
  c0:	e1a00005 	mov	r0, r5
  c4:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  c8:	e1a00005 	mov	r0, r5
  cc:	e595101c 	ldr	r1, [r5, #28]
  d0:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
...
00000000 <vex::motor::spinToPosition(double, vex::rotationUnits, double, vex::velocityUnits, bool)>:
   0:	e92d4030 	push	{r4, r5, lr}
   4:	e5dd1020 	ldrb	r1, [sp, #32]
   8:	e58d1020 	str	r1, [sp, #32]
   c:	e8bd4030 	pop	{r4, r5, lr}
  10:	eafffffe 	b	0 <vex::motor::spinToPosition(double, vex::rotationUnits, double, vex::velocityUnits, bool)>

Disassembly of section .text._ZN3vex5motor6spinToEdNS_13rotationUnitsEb:

00000000 <vex::motor::spinTo(double, vex::rotationUnits, bool)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e59d1020 	ldr	r1, [sp, #32]
   8:	e58d1000 	str	r1, [sp]
   c:	e3a01001 	mov	r1, #1
  ...
  28:	ebfffffe 	bl	0 <vex::motor::spinTo(double, vex::rotationUnits, bool)>
...
00000000 <vex::motor::spinToPosition(double, vex::rotationUnits, bool)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e59d1020 	ldr	r1, [sp, #32]
   8:	e58d1000 	str	r1, [sp]
   c:	e3a01001 	mov	r1, #1
  ...
  20:	e58d1014 	str	r1, [sp, #20]
  24:	edcd0b02 	vstr	d16, [sp, #8]
  28:	ebfffffe 	bl	0 <vex::motor::spinToPosition(double, vex::rotationUnits, bool)>
  2c:	e28dd01c 	add	sp, sp, #28
  30:	e49df004 	pop	{pc}		; (ldr pc, [sp], #4)

Disassembly of section .text._ZN3vex5motor7spinForEdNS_13rotationUnitsEdNS_13velocityUnitsEb:

00000000 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
  ...
  20:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  24:	eeb58b40 	vcmp.f64	d8, #0.0
  28:	eef1fa10 	vmrs	APSR_nzcv, fpscr
  2c:	03a00001 	moveq	r0, #1
  30:	0a00002c 	beq	e8 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xe8>
  ...
  48:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  ...
  7c:	1a000001 	bne	88 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x88>
  80:	e3a00000 	mov	r0, #0
  84:	ea000017 	b	e8 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xe8>
  88:	e5956010 	ldr	r6, [r5, #16]
  8c:	e1e03006 	mvn	r3, r6
  90:	e1a03fa3 	lsr	r3, r3, #31
  94:	e1540003 	cmp	r4, r3
  98:	2a00000a 	bcs	c8 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xc8>
  ...
  b4:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  b8:	e3500000 	cmp	r0, #0
  bc:	0affffef 	beq	80 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x80>
  c0:	e246600a 	sub	r6, r6, #10
  c4:	eafffff0 	b	8c <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x8c>
  c8:	e3540000 	cmp	r4, #0
  cc:	1a000001 	bne	d8 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0xd8>
  d0:	e1a00005 	mov	r0, r5
  d4:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
  d8:	e1a00005 	mov	r0, r5
  dc:	e595101c 	ldr	r1, [r5, #28]
  e0:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)>
...
00000000 <vex::motor::spinFor(vex::directionType, double, vex::rotationUnits, double, vex::velocityUnits, bool)>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
   4:	e3510000 	cmp	r1, #0
  ...
  30:	eafffffe 	b	0 <vex::motor::spinFor(vex::directionType, double, vex::rotationUnits, double, vex::velocityUnits, bool)>

Disassembly of section .text._ZN3vex5motor7spinForEdNS_13rotationUnitsEb:

00000000 <vex::motor::spinFor(double, vex::rotationUnits, bool)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e59d1020 	ldr	r1, [sp, #32]
   8:	e58d1000 	str	r1, [sp]
   c:	e3a01001 	mov	r1, #1
  ...
  20:	e58d1014 	str	r1, [sp, #20]
  24:	edcd0b02 	vstr	d16, [sp, #8]
  28:	ebfffffe 	bl	0 <vex::motor::spinFor(double, vex::rotationUnits, bool)>
  2c:	e28dd01c 	add	sp, sp, #28
  30:	e49df004 	pop	{pc}		; (ldr pc, [sp], #4)

Disassembly of section .text._ZN3vex5motor7spinForENS_13directionTypeEdNS_13rotationUnitsEb:

00000000 <vex::motor::spinFor(vex::directionType, double, vex::rotationUnits, bool)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e3510000 	cmp	r1, #0
  ...
  30:	ebfffffe 	bl	0 <vex::motor::spinFor(vex::directionType, double, vex::rotationUnits, bool)>
...
00000000 <vex::motor::position(vex::rotationUnits)>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e1a05001 	mov	r5, r1
   c:	e3a00001 	mov	r0, #1
  ...
  1c:	ebfffffe 	bl	0 <vex::motor::position(vex::rotationUnits)>
  20:	e5940008 	ldr	r0, [r4, #8]
...
00000000 <vtable for vex::motor>:
	...

Disassembly of section .data._ZN3vex24__default_motor_velocityE:

00000000 <vex::__default_motor_velocity>:
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::motor::spinFor(double, vex::rotationUnits, double, vex::velocityUnits, bool)+0x80a5e0>

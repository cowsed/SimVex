...
v5_apiversions.c.obj:     file format elf32-littlearm


Disassembly of section .text.vexSystemVersion:

00000000 <vexSystemVersion>:
   0:	e59f3004 	ldr	r3, [pc, #4]	; c <vexSystemVersion+0xc>
   4:	e5930000 	ldr	r0, [r3]
   8:	e12fff1e 	bx	lr
   c:	037fd000 	cmneq	pc, #0

Disassembly of section .text.vexStdlibVersion:

00000000 <vexStdlibVersion>:
   0:	e59f3004 	ldr	r3, [pc, #4]	; c <vexStdlibVersion+0xc>
   4:	e5930004 	ldr	r0, [r3, #4]
   8:	e12fff1e 	bx	lr
   c:	037fd000 	cmneq	pc, #0

Disassembly of section .text.vexSdkVersion:

00000000 <vexSdkVersion>:
   0:	e59f0000 	ldr	r0, [pc]	; 8 <vexSdkVersion+0x8>
   4:	e12fff1e 	bx	lr
   8:	01020000 	mrseq	r0, (UNDEF: 2)

Disassembly of section .text.vexVexosVersion:

00000000 <vexVexosVersion>:
   0:	e59f3004 	ldr	r3, [pc, #4]	; c <vexVexosVersion+0xc>
   4:	e5930008 	ldr	r0, [r3, #8]
   8:	e12fff1e 	bx	lr
   c:	037fd000 	cmneq	pc, #0

Disassembly of section .text.vexCpu0Version:

00000000 <vexCpu0Version>:
   0:	e59f3004 	ldr	r3, [pc, #4]	; c <vexCpu0Version+0xc>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vexCpu0Version+0x80a5e0>

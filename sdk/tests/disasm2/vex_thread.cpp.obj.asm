...
00000000 <vex::thread::thread(int (*)())>:
  ...
  18:	e59f3034 	ldr	r3, [pc, #52]	; 54 <vex::thread::thread(int (*)())+0x54>
  1c:	e1a05001 	mov	r5, r1
  20:	e1a0000d 	mov	r0, sp
  24:	e5932000 	ldr	r2, [r3]
  28:	e2821001 	add	r1, r2, #1
  2c:	e5831000 	str	r1, [r3]
  30:	e59f1020 	ldr	r1, [pc, #32]	; 58 <vex::thread::thread(int (*)())+0x58>
...
00000000 <vex::thread::thread(int (*)(void*), void*)>:
   0:	e92d407f 	push	{r0, r1, r2, r3, r4, r5, r6, lr}
   4:	e1a06002 	mov	r6, r2
   8:	e59f3044 	ldr	r3, [pc, #68]	; 54 <vex::thread::thread(int (*)(void*), void*)+0x54>
  ...
  28:	e59f1028 	ldr	r1, [pc, #40]	; 58 <vex::thread::thread(int (*)(void*), void*)+0x58>
...
00000000 <vex::thread::~thread()>:
   0:	e12fff1e 	bx	lr

Disassembly of section .text._ZN3vex6thread8joinableEv:

00000000 <vex::thread::joinable()>:
...
00000000 <vex::thread::interruptAll()>:
   0:	e92d4073 	push	{r0, r1, r4, r5, r6, lr}
   4:	e59f007c 	ldr	r0, [pc, #124]	; 88 <vex::thread::interruptAll()+0x88>
   8:	e3500000 	cmp	r0, #0
   c:	0a00001b 	beq	80 <vex::thread::interruptAll()+0x80>
...
00000000 <vex::thread::setPriority(long)>:
   0:	e1a03000 	mov	r3, r0
   4:	e5900000 	ldr	r0, [r0]
...
00000000 <vex::this_thread::setPriority(long)>:
  ...
  18:	ba000006 	blt	38 <vex::this_thread::setPriority(long)+0x38>
  1c:	e28d1004 	add	r1, sp, #4
  20:	ebfffffe 	bl	0 <vexTaskGetCallbackAndId>
  24:	e3500000 	cmp	r0, #0
  28:	0a000002 	beq	38 <vex::this_thread::setPriority(long)+0x38>
...
00000000 <.rodata.str1.1>:
   ...
   c:	255f4152 	ldrbcs	r4, [pc, #-338]	; fffffec2 <vex::thread::interruptAll()+0xfffffec2>
  10:	00643230 	rsbeq	r3, r4, r0, lsr r2

Disassembly of section .bss._ZN3vex6thread8_labelIdE:

00000000 <vex::thread::_labelId>:
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <vex::thread::interruptAll()+0x80a5e0>

...
00000000 <_ZNK3vex6meventcviEv>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e5903000 	ldr	r3, [r0]
   8:	e353001f 	cmp	r3, #31
   c:	9a000001 	bls	18 <_ZNK3vex6meventcviEv+0x18>
  ...
  34:	0afffff5 	beq	10 <_ZNK3vex6meventcviEv+0x10>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex6meventC1Emm+0x80a5e0>

...
00000000 <_ZNK3vex10controller6button8pressingEv>:
   0:	e92d4008 	push	{r3, lr}
  ...
  20:	ea000026 	b	c0 <_ZNK3vex10controller6button8pressingEv+0xc0>
  ...
  58:	ea000014 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  5c:	e3a01007 	mov	r1, #7
  60:	ea000012 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  64:	e3a01008 	mov	r1, #8
  68:	ea000010 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  6c:	e3a01009 	mov	r1, #9
  70:	ea00000e 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  74:	e3a0100a 	mov	r1, #10
  78:	ea00000c 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  7c:	e3a0100b 	mov	r1, #11
  80:	ea00000a 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  84:	e3a0100c 	mov	r1, #12
  88:	ea000008 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  8c:	e3a0100d 	mov	r1, #13
  90:	ea000006 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  94:	e3a0100e 	mov	r1, #14
  98:	ea000004 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  9c:	e3a0100f 	mov	r1, #15
  a0:	ea000002 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  a4:	e3a01010 	mov	r1, #16
  a8:	ea000000 	b	b0 <_ZNK3vex10controller6button8pressingEv+0xb0>
  ac:	e3a01011 	mov	r1, #17
  b0:	ebfffffe 	bl	0 <_ZNK3vex10controller6button8pressingEv>
...
00000000 <_ZNK3vex10controller6button7pressedEPFvvE>:
   0:	e5903000 	ldr	r3, [r0]
   4:	e1a02001 	mov	r2, r1
   8:	e353000b 	cmp	r3, #11
   c:	979ff103 	ldrls	pc, [pc, r3, lsl #2]
  10:	ea00003b 	b	104 <_ZNK3vex10controller6button7pressedEPFvvE+0x104>
...
00000000 <_ZNK3vex10controller6button8releasedEPFvvE>:
  ...
  4c:	e5930004 	ldr	r0, [r3, #4]
  50:	ea00002a 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  54:	e5903004 	ldr	r3, [r0, #4]
  58:	e3a01008 	mov	r1, #8
  5c:	e5930004 	ldr	r0, [r3, #4]
  60:	ea000026 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  64:	e5903004 	ldr	r3, [r0, #4]
  68:	e3a01020 	mov	r1, #32
  6c:	e5930004 	ldr	r0, [r3, #4]
  70:	ea000022 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  74:	e5903004 	ldr	r3, [r0, #4]
  78:	e3a01080 	mov	r1, #128	; 0x80
  7c:	e5930004 	ldr	r0, [r3, #4]
  80:	ea00001e 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  84:	e5903004 	ldr	r3, [r0, #4]
  88:	e3a01c02 	mov	r1, #512	; 0x200
  8c:	e5930004 	ldr	r0, [r3, #4]
  90:	ea00001a 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  94:	e5903004 	ldr	r3, [r0, #4]
  98:	e3a01b02 	mov	r1, #2048	; 0x800
  9c:	e5930004 	ldr	r0, [r3, #4]
  a0:	ea000016 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  a4:	e5903004 	ldr	r3, [r0, #4]
  a8:	e3a01a02 	mov	r1, #8192	; 0x2000
  ac:	e5930004 	ldr	r0, [r3, #4]
  b0:	ea000012 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  b4:	e5903004 	ldr	r3, [r0, #4]
  b8:	e3a01902 	mov	r1, #32768	; 0x8000
  bc:	e5930004 	ldr	r0, [r3, #4]
  c0:	ea00000e 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  c4:	e5903004 	ldr	r3, [r0, #4]
  c8:	e3a01802 	mov	r1, #131072	; 0x20000
  cc:	e5930004 	ldr	r0, [r3, #4]
  d0:	ea00000a 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  d4:	e5903004 	ldr	r3, [r0, #4]
  d8:	e3a01702 	mov	r1, #524288	; 0x80000
  dc:	e5930004 	ldr	r0, [r3, #4]
  e0:	ea000006 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  e4:	e5903004 	ldr	r3, [r0, #4]
  e8:	e3a01602 	mov	r1, #2097152	; 0x200000
  ec:	e5930004 	ldr	r0, [r3, #4]
  f0:	ea000002 	b	100 <_ZNK3vex10controller6button8releasedEPFvvE+0x100>
  f4:	e5903004 	ldr	r3, [r0, #4]
...
00000000 <_ZNK3vex10controller6button21_buttonToPressedEventEv>:
   0:	e5903000 	ldr	r3, [r0]
   4:	e2433001 	sub	r3, r3, #1
   8:	e353000a 	cmp	r3, #10
   c:	959f2008 	ldrls	r2, [pc, #8]	; 1c <_ZNK3vex10controller6button21_buttonToPressedEventEv+0x1c>
...
00000000 <_ZNK3vex10controller6button22_buttonToReleasedEventEv>:
   0:	e5903000 	ldr	r3, [r0]
   4:	e2433001 	sub	r3, r3, #1
   8:	e353000a 	cmp	r3, #10
   c:	959f2008 	ldrls	r2, [pc, #8]	; 1c <_ZNK3vex10controller6button22_buttonToReleasedEventEv+0x1c>
  10:	919200d3 	ldrsbls	r0, [r2, r3]
...
00000000 <_ZNK3vex10controller4axis5valueEv>:
  ...
  34:	ea000004 	b	4c <_ZNK3vex10controller4axis5valueEv+0x4c>
  38:	e3a01000 	mov	r1, #0
  3c:	ea000002 	b	4c <_ZNK3vex10controller4axis5valueEv+0x4c>
  40:	e3a01002 	mov	r1, #2
  44:	ea000000 	b	4c <_ZNK3vex10controller4axis5valueEv+0x4c>
  48:	e3a01003 	mov	r1, #3
  4c:	eafffffe 	b	0 <_ZNK3vex10controller4axis5valueEv>
  50:	e3a00000 	mov	r0, #0
  54:	e12fff1e 	bx	lr

Disassembly of section .text._ZNK3vex10controller4axis8positionENS_12percentUnitsE:

00000000 <_ZNK3vex10controller4axis8positionENS_12percentUnitsE>:
   0:	e92d4008 	push	{r3, lr}
   4:	ebfffffe 	bl	0 <_ZNK3vex10controller4axis8positionENS_12percentUnitsE>
...
00000000 <_ZNK3vex10controller4axis7changedEPFvvE>:
   0:	e5903000 	ldr	r3, [r0]
   4:	e1a02001 	mov	r2, r1
   8:	e3530003 	cmp	r3, #3
   c:	979ff103 	ldrls	pc, [pc, r3, lsl #2]
  10:	ea000013 	b	64 <_ZNK3vex10controller4axis7changedEPFvvE+0x64>
  ...
  30:	ea00000a 	b	60 <_ZNK3vex10controller4axis7changedEPFvvE+0x60>
  34:	e5903004 	ldr	r3, [r0, #4]
  38:	e3a01402 	mov	r1, #33554432	; 0x2000000
  3c:	e5930004 	ldr	r0, [r3, #4]
  40:	ea000006 	b	60 <_ZNK3vex10controller4axis7changedEPFvvE+0x60>
  44:	e5903004 	ldr	r3, [r0, #4]
  48:	e3a01301 	mov	r1, #67108864	; 0x4000000
  4c:	e5930004 	ldr	r0, [r3, #4]
  50:	ea000002 	b	60 <_ZNK3vex10controller4axis7changedEPFvvE+0x60>
  54:	e5903004 	ldr	r3, [r0, #4]
  58:	e3a01302 	mov	r1, #134217728	; 0x8000000
  5c:	e5930004 	ldr	r0, [r3, #4]
  60:	eafffffe 	b	0 <_ZN3vex5event4initEmmPFvvE>
  64:	e12fff1e 	bx	lr

Disassembly of section .text._ZNK3vex10controller4axis23_joystickToChangedEventEv:

00000000 <_ZNK3vex10controller4axis23_joystickToChangedEventEv>:
   0:	e5903000 	ldr	r3, [r0]
   4:	e2433001 	sub	r3, r3, #1
   8:	e3530002 	cmp	r3, #2
   c:	959f2008 	ldrls	r2, [pc, #8]	; 1c <_ZNK3vex10controller4axis23_joystickToChangedEventEv+0x1c>
  10:	919200d3 	ldrsbls	r0, [r2, r3]
...
00000000 <_ZN3vex10controller4axisC1ENS0_9tAxisTypeEPS0_>:
   0:	e92d4038 	push	{r3, r4, r5, lr}
   4:	e1a05002 	mov	r5, r2
   8:	e8800022 	stm	r0, {r1, r5}
   c:	e1a04000 	mov	r4, r0
  10:	ebfffffe 	bl	0 <_ZN3vex10controller4axisC1ENS0_9tAxisTypeEPS0_>
  14:	e5951004 	ldr	r1, [r5, #4]
  18:	e1a02000 	mov	r2, r0
  1c:	e2840008 	add	r0, r4, #8
  20:	ebfffffe 	bl	0 <_ZN3vex6meventC1Emm>
...
00000000 <_ZN3vex10controllerC1ENS_14controllerTypeE>:
   0:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e5841000 	str	r1, [r4]
   c:	e1a05001 	mov	r5, r1
  10:	ebfffffe 	bl	0 <_ZN3vex5event9userindexEv>
...
00000000 <_ZN3vex10controllerC1Ev>:
   0:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
   4:	e3a05000 	mov	r5, #0
...
00000000 <_ZN3vex10controller3lcdC1Ev>:
   0:	e3a02000 	mov	r2, #0
...
00000000 <_ZN3vex10controller3lcdC1EPS0_>:
   0:	e3a02003 	mov	r2, #3
...
00000000 <_ZN3vex10controller3lcd15getControllerIdEv>:
...
00000000 <_ZN3vex10controller3lcd9setCursorEll>:
   0:	e3510000 	cmp	r1, #0
...
00000000 <_ZN3vex10controller3lcd5printEPKcz>:
  ...
  34:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd5printEPKcz>
...
00000000 <_ZN3vex10controller3lcd5printEPcz>:
   0:	e92d000e 	push	{r1, r2, r3}
   4:	e92d4033 	push	{r0, r1, r4, r5, lr}
   8:	e2805014 	add	r5, r0, #20
   c:	e1a04000 	mov	r4, r0
  ...
  2c:	e1a00004 	mov	r0, r4
  30:	e5c43033 	strb	r3, [r4, #51]	; 0x33
  34:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd5printEPcz>
  38:	e594200c 	ldr	r2, [r4, #12]
  3c:	e1a03005 	mov	r3, r5
  40:	e5941004 	ldr	r1, [r4, #4]
  44:	e2422001 	sub	r2, r2, #1
...
00000000 <_ZN3vex10controller3lcd9clearLineEi>:
   0:	e3510000 	cmp	r1, #0
   4:	d12fff1e 	bxle	lr
  ...
  2c:	e59f3040 	ldr	r3, [pc, #64]	; 74 <_ZN3vex10controller3lcd9clearLineEi+0x74>
  30:	e1500003 	cmp	r0, r3
  34:	e1a00004 	mov	r0, r4
  38:	9a000005 	bls	54 <_ZN3vex10controller3lcd9clearLineEi+0x54>
  3c:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd9clearLineEi>
  40:	e1a01005 	mov	r1, r5
  44:	e3a02000 	mov	r2, #0
  48:	e59f3028 	ldr	r3, [pc, #40]	; 78 <_ZN3vex10controller3lcd9clearLineEi+0x78>
  4c:	e6ef0070 	uxtb	r0, r0
  50:	ea000005 	b	6c <_ZN3vex10controller3lcd9clearLineEi+0x6c>
  54:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd9clearLineEi>
  58:	e594200c 	ldr	r2, [r4, #12]
  5c:	e59f3018 	ldr	r3, [pc, #24]	; 7c <_ZN3vex10controller3lcd9clearLineEi+0x7c>
...
00000000 <_ZN3vex10controller3lcd11clearScreenEv>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <vexSystemVersion>
   c:	e3500401 	cmp	r0, #16777216	; 0x1000000
  10:	e1a00004 	mov	r0, r4
  14:	9a000006 	bls	34 <_ZN3vex10controller3lcd11clearScreenEv+0x34>
  18:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd11clearScreenEv>
  1c:	e3a01000 	mov	r1, #0
  20:	e1a02001 	mov	r2, r1
  24:	e59f302c 	ldr	r3, [pc, #44]	; 58 <_ZN3vex10controller3lcd11clearScreenEv+0x58>
  28:	e8bd4010 	pop	{r4, lr}
  2c:	e6ef0070 	uxtb	r0, r0
  30:	eafffffe 	b	0 <vexControllerTextSet>
  34:	e3a01001 	mov	r1, #1
  38:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd11clearScreenEv>
  3c:	e1a00004 	mov	r0, r4
  40:	e3a01002 	mov	r1, #2
  44:	ebfffffe 	bl	0 <_ZN3vex10controller3lcd11clearScreenEv>
  48:	e1a00004 	mov	r0, r4
  4c:	e3a01003 	mov	r1, #3
  50:	e8bd4010 	pop	{r4, lr}
  54:	eafffffe 	b	0 <_ZN3vex10controller3lcd11clearScreenEv>
  58:	00000000 	andeq	r0, r0, r0

Disassembly of section .text._ZN3vex10controller3lcd9clearLineEv:

00000000 <_ZN3vex10controller3lcd9clearLineEv>:
   0:	e3a01001 	mov	r1, #1
   4:	eafffffe 	b	0 <_ZN3vex10controller3lcd9clearLineEv>

Disassembly of section .text._ZN3vex10controller3lcd7newLineEv:

00000000 <_ZN3vex10controller3lcd7newLineEv>:
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex10controllerC1ENS_14controllerTypeE+0x80a5e0>

...
00000000 <_ZN3vex7console5writeElPcl>:
  ...
  38:	aa000024 	bge	d0 <_ZN3vex7console5writeElPcl+0xd0>
  3c:	e4d43001 	ldrb	r3, [r4], #1
  40:	e353000a 	cmp	r3, #10
  44:	1a000010 	bne	8c <_ZN3vex7console5writeElPcl+0x8c>
  ...
  68:	e59f3078 	ldr	r3, [pc, #120]	; e8 <_ZN3vex7console5writeElPcl+0xe8>
  6c:	e3a010ec 	mov	r1, #236	; 0xec
  70:	ebfffffe 	bl	0 <vexDisplayPrintf>
  74:	e59f006c 	ldr	r0, [pc, #108]	; e8 <_ZN3vex7console5writeElPcl+0xe8>
  78:	ebfffffe 	bl	0 <vexDisplayStringWidthGet>
  7c:	e59f3068 	ldr	r3, [pc, #104]	; ec <_ZN3vex7console5writeElPcl+0xec>
  80:	e2800004 	add	r0, r0, #4
  84:	e5830000 	str	r0, [r3]
  88:	eaffffe8 	b	30 <_ZN3vex7console5writeElPcl+0x30>
  8c:	e353001f 	cmp	r3, #31
  90:	9affffe6 	bls	30 <_ZN3vex7console5writeElPcl+0x30>
  94:	e59f5050 	ldr	r5, [pc, #80]	; ec <_ZN3vex7console5writeElPcl+0xec>
  98:	e3a010ec 	mov	r1, #236	; 0xec
  9c:	e58d3000 	str	r3, [sp]
  a0:	e3a02000 	mov	r2, #0
  a4:	e59f3044 	ldr	r3, [pc, #68]	; f0 <_ZN3vex7console5writeElPcl+0xf0>
  ...
  cc:	eaffffd7 	b	30 <_ZN3vex7console5writeElPcl+0x30>
...
00000000 <_ZN3vex7consoleC1Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <_ZN3vex5brainC2Ev>
   c:	e59f0034 	ldr	r0, [pc, #52]	; 48 <_ZN3vex7consoleC1Ev+0x48>
  10:	ebfffffe 	bl	0 <vexSystemUserWriteInstall>
  14:	e3a01008 	mov	r1, #8
  18:	e1a00004 	mov	r0, r4
  1c:	ebfffffe 	bl	0 <_ZN3vex5brain3lcd7setFontENS_8fontTypeE>
  ...
  30:	e59f1014 	ldr	r1, [pc, #20]	; 4c <_ZN3vex7consoleC1Ev+0x4c>
  34:	e3a02001 	mov	r2, #1
  38:	e3a00000 	mov	r0, #0
  3c:	ebfffffe 	bl	0 <_ZN3vex7consoleC1Ev>
...
00000000 <_ZN3vex7consoleD1Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	e3a00000 	mov	r0, #0
   c:	ebfffffe 	bl	0 <vexSystemUserWriteInstall>
  10:	e1a00004 	mov	r0, r4
  14:	ebfffffe 	bl	0 <_ZN3vex5brainD2Ev>
  18:	e1a00004 	mov	r0, r4
  1c:	e8bd8010 	pop	{r4, pc}

Disassembly of section .text._ZN3vex7console4initEv:

00000000 <_ZN3vex7console4initEv>:
   0:	e92d4008 	push	{r3, lr}
   4:	e3a01008 	mov	r1, #8
   8:	ebfffffe 	bl	0 <_ZN3vex5brain3lcd7setFontENS_8fontTypeE>
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex7console5writeElPcl+0x80a5e0>

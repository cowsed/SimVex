...
00000000 <_ZN3vex6vision9installedEv>:
...
00000000 <_ZN3vex6visionD1Ev>:
   0:	e59f302c 	ldr	r3, [pc, #44]	; 34 <_ZN3vex6visionD1Ev+0x34>
  ...
  20:	1afffffc 	bne	18 <_ZN3vex6visionD1Ev+0x18>
...
00000000 <_ZN3vex6visionD0Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <_ZN3vex6visionD0Ev>
...
00000000 <_ZN3vex6vision12setSignatureEP25_V5_DeviceVisionSignature>:
   0:	e92d4008 	push	{r3, lr}
   4:	e2513000 	subs	r3, r1, #0
   8:	0a000003 	beq	1c <_ZN3vex6vision12setSignatureEP25_V5_DeviceVisionSignature+0x1c>
...
00000000 <_ZN3vex6vision12setSignatureERNS0_9signatureE>:
...
00000000 <_ZN3vex6vision12getSignatureEmP25_V5_DeviceVisionSignature>:
   0:	e2523000 	subs	r3, r2, #0
   4:	0a000001 	beq	10 <_ZN3vex6vision12getSignatureEmP25_V5_DeviceVisionSignature+0x10>
...
00000000 <_ZN3vex6vision12getSignatureEmRNS0_9signatureE>:
   0:	e92d4010 	push	{r4, lr}
...
00000000 <_ZN3vex6vision7setModeENS0_13detectionModeE>:
   0:	e92d4008 	push	{r3, lr}
...
00000000 <_ZN3vex6vision7getModeEv>:
   0:	e92d4008 	push	{r3, lr}
...
00000000 <_ZN3vex6vision13setBrightnessEh>:
   0:	e92d4010 	push	{r4, lr}
...
00000000 <_ZN3vex6vision13getBrightnessEv>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision19setWhiteBalanceModeENS0_16whiteBalanceModeE>:
   0:	e92d4008 	push	{r3, lr}
   4:	e6ef1071 	uxtb	r1, r1
   8:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision19getWhiteBalanceModeEv>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision21setWhiteBalanceValuesEhhh>:
...
00000000 <_ZN3vex6vision21getWhiteBalanceValuesEPhS1_S1_>:
...
00000000 <_ZN3vex6vision10setLedModeENS0_7ledModeE>:
   0:	e92d4008 	push	{r3, lr}
   4:	e6ef1071 	uxtb	r1, r1
   8:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision10getLedModeEv>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision16setLedBrightnessEh>:
...
00000000 <_ZN3vex6vision16getLedBrightnessEv>:
...
00000000 <_ZN3vex6vision11setLedColorEhhh>:
   0:	e92d4007 	push	{r0, r1, r2, lr}
   4:	e3e0c000 	mvn	ip, #0
...
00000000 <_ZN3vex6vision11getLedColorEPhS1_S1_>:
   0:	e92d4073 	push	{r0, r1, r4, r5, r6, lr}
   4:	e1a04003 	mov	r4, r3
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	e1a06001 	mov	r6, r1
...
00000000 <_ZN3vex6vision11setWifiModeENS0_8wifiModeE>:
   0:	e92d4008 	push	{r3, lr}
   4:	e6ef1071 	uxtb	r1, r1
   8:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision11getWifiModeEv>:
   0:	e92d4008 	push	{r3, lr}
   4:	e5900008 	ldr	r0, [r0, #8]
...
00000000 <_ZN3vex6vision9signatureD1Ev>:
   0:	e12fff1e 	bx	lr

Disassembly of section .text._ZN3vex6vision9signature5clearEv:

00000000 <_ZN3vex6vision9signature5clearEv>:
   0:	e59f202c 	ldr	r2, [pc, #44]	; 34 <_ZN3vex6vision9signature5clearEv+0x34>
   4:	e3a03000 	mov	r3, #0
...
00000000 <_ZN3vex6vision9signatureC1Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
...
00000000 <_ZN3vex6vision4codeC1Elllll>:
  ...
  38:	1a00001a 	bne	a8 <_ZN3vex6vision4codeC1Elllll+0xa8>
  ...
  a4:	ea00000e 	b	e4 <_ZN3vex6vision4codeC1Elllll+0xe4>
  ...
  d0:	eafffff1 	b	9c <_ZN3vex6vision4codeC1Elllll+0x9c>
  ...
  ec:	0afffff8 	beq	d4 <_ZN3vex6vision4codeC1Elllll+0xd4>
  f0:	e8bd8070 	pop	{r4, r5, r6, pc}

Disassembly of section .text._ZN3vex6vision4codeC2Ellll:

00000000 <_ZN3vex6vision4codeC1Ellll>:
  ...
  18:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1Ellll>
  1c:	e1a00004 	mov	r0, r4
...
00000000 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_S3_>:
  ...
  2c:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_S3_>
...
00000000 <_ZN3vex6vision4codeC1Elll>:
   0:	e92d4013 	push	{r0, r1, r4, lr}
   4:	e3a0c000 	mov	ip, #0
   8:	e58dc000 	str	ip, [sp]
   c:	e1a04000 	mov	r4, r0
  10:	e58dc004 	str	ip, [sp, #4]
  14:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1Elll>
...
00000000 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_>:
   0:	e92d40f8 	push	{r3, r4, r5, r6, r7, lr}
  ...
  20:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_>
...
00000000 <_ZN3vex6vision4codeC1Ell>:
   0:	e92d4013 	push	{r0, r1, r4, lr}
   4:	e3a03000 	mov	r3, #0
   8:	e58d3000 	str	r3, [sp]
   c:	e1a04000 	mov	r4, r0
  10:	e58d3004 	str	r3, [sp, #4]
  14:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1Ell>
  18:	e1a00004 	mov	r0, r4
  1c:	e28dd008 	add	sp, sp, #8
  20:	e8bd8010 	pop	{r4, pc}
...
00000000 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
  ...
  18:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_>
...
00000000 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_S3_S3_>:
  ...
  38:	ebfffffe 	bl	0 <_ZN3vex6vision4codeC1ERNS0_9signatureES3_S3_S3_S3_>
...
00000000 <_ZN3vex6vision6objectD1Ev>:
   0:	e12fff1e 	bx	lr

Disassembly of section .text._ZN3vex6vision6object3setE22_V5_DeviceVisionObject:

00000000 <_ZN3vex6vision6object3setE22_V5_DeviceVisionObject>:
   0:	e24dd010 	sub	sp, sp, #16
   4:	eddf1b19 	vldr	d17, [pc, #100]	; 70 <_ZN3vex6vision6object3setE22_V5_DeviceVisionObject+0x70>
...
00000000 <_ZN3vex6vision6object9flipAngleEv>:
   0:	edd00b08 	vldr	d16, [r0, #32]
   4:	eddf1b07 	vldr	d17, [pc, #28]	; 28 <_ZN3vex6vision6object9flipAngleEv+0x28>
   8:	ee700ba1 	vadd.f64	d16, d16, d17
   c:	eddf1b07 	vldr	d17, [pc, #28]	; 30 <_ZN3vex6vision6object9flipAngleEv+0x30>
...
00000000 <_ZN3vex6vision6object5clearEv>:
   0:	e3a03000 	mov	r3, #0
...
00000000 <_ZN3vex6vision6objectC1Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
...
00000000 <_ZN3vex6vision13_clearObjectsEv>:
  ...
  28:	ebfffffe 	bl	0 <_ZN3vex6vision13_clearObjectsEv>
  2c:	e3550010 	cmp	r5, #16
  30:	1afffff6 	bne	10 <_ZN3vex6vision13_clearObjectsEv+0x10>
  34:	e2840018 	add	r0, r4, #24
  38:	e8bd4070 	pop	{r4, r5, r6, lr}
  3c:	eafffffe 	b	0 <_ZN3vex6vision13_clearObjectsEv>

Disassembly of section .text._ZN3vex6vision6objectaSERKS1_:

00000000 <_ZN3vex6vision6objectaSERKS1_>:
...
00000000 <_ZN3vex6vision12takeSnapshotEmm>:
  ...
  34:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotEmm>
  38:	e356000f 	cmp	r6, #15
  3c:	91560009 	cmpls	r6, r9
  40:	2a000027 	bcs	e4 <_ZN3vex6vision12takeSnapshotEmm+0xe4>
  ...
  6c:	1a000019 	bne	d8 <_ZN3vex6vision12takeSnapshotEmm+0xd8>
  70:	e155000a 	cmp	r5, sl
  74:	2a000017 	bcs	d8 <_ZN3vex6vision12takeSnapshotEmm+0xd8>
  ...
  b0:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotEmm>
  b4:	e3550000 	cmp	r5, #0
  b8:	1a000005 	bne	d4 <_ZN3vex6vision12takeSnapshotEmm+0xd4>
  ...
  d0:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotEmm>
  d4:	e2855001 	add	r5, r5, #1
  d8:	e2866001 	add	r6, r6, #1
  dc:	e287700d 	add	r7, r7, #13
  e0:	eaffffd4 	b	38 <_ZN3vex6vision12takeSnapshotEmm+0x38>
...
00000000 <_ZN3vex6vision12takeSnapshotEm>:
   0:	e3a02008 	mov	r2, #8
   4:	eafffffe 	b	0 <_ZN3vex6vision12takeSnapshotEm>

Disassembly of section .text._ZN3vex6vision5valueEv:

00000000 <_ZN3vex6vision5valueEv>:
   0:	e3a01001 	mov	r1, #1
   4:	eafffffe 	b	0 <_ZN3vex6vision5valueEv>

Disassembly of section .text._ZN3vex6vision12takeSnapshotERNS0_4codeE:

00000000 <_ZN3vex6vision12takeSnapshotERNS0_4codeE>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
   4:	e3a02008 	mov	r2, #8
   8:	e1a05001 	mov	r5, r1
   c:	e5911000 	ldr	r1, [r1]
  10:	e1a04000 	mov	r4, r0
  14:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeE>
  18:	e2506000 	subs	r6, r0, #0
  1c:	da000009 	ble	48 <_ZN3vex6vision12takeSnapshotERNS0_4codeE+0x48>
  20:	e5d53004 	ldrb	r3, [r5, #4]
  24:	e3530000 	cmp	r3, #0
  28:	0a000006 	beq	48 <_ZN3vex6vision12takeSnapshotERNS0_4codeE+0x48>
  2c:	e5943068 	ldr	r3, [r4, #104]	; 0x68
  30:	e3530000 	cmp	r3, #0
  34:	c2840070 	addgt	r0, r4, #112	; 0x70
  38:	d2840e57 	addle	r0, r4, #1392	; 0x570
  3c:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeE>
  40:	e2840018 	add	r0, r4, #24
  44:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeE>
  48:	e1a00006 	mov	r0, r6
  4c:	e8bd8070 	pop	{r4, r5, r6, pc}

Disassembly of section .text._ZN3vex6vision12takeSnapshotERNS0_4codeEm:

00000000 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm>:
   0:	e92d4070 	push	{r4, r5, r6, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5911000 	ldr	r1, [r1]
   c:	e1a05000 	mov	r5, r0
  10:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm>
  14:	e2506000 	subs	r6, r0, #0
  18:	da000013 	ble	6c <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x6c>
  1c:	e5d43004 	ldrb	r3, [r4, #4]
  20:	e3530000 	cmp	r3, #0
  24:	0a000010 	beq	6c <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x6c>
  ...
  40:	ca000000 	bgt	48 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x48>
  44:	e2850e57 	add	r0, r5, #1392	; 0x570
  48:	e2844001 	add	r4, r4, #1
  4c:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm>
  50:	e1540006 	cmp	r4, r6
  54:	aa000002 	bge	64 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x64>
  58:	e3540000 	cmp	r4, #0
  5c:	aafffff2 	bge	2c <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x2c>
  60:	eafffff7 	b	44 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm+0x44>
  64:	e2850018 	add	r0, r5, #24
  68:	ebfffffe 	bl	0 <_ZN3vex6vision12takeSnapshotERNS0_4codeEm>
...
00000000 <_ZN3vex6vision12takeSnapshotERNS0_9signatureE>:
   0:	e5913028 	ldr	r3, [r1, #40]	; 0x28
   4:	e3a02008 	mov	r2, #8
   8:	e5931000 	ldr	r1, [r3]
   c:	eafffffe 	b	0 <_ZN3vex6vision12takeSnapshotERNS0_9signatureE>

Disassembly of section .text._ZN3vex6vision12takeSnapshotERNS0_9signatureEm:

00000000 <_ZN3vex6vision12takeSnapshotERNS0_9signatureEm>:
   0:	e5913028 	ldr	r3, [r1, #40]	; 0x28
   4:	e5931000 	ldr	r1, [r3]
   8:	eafffffe 	b	0 <_ZN3vex6vision12takeSnapshotERNS0_9signatureEm>

Disassembly of section .text._ZN3vex6vision6objectaSEl:

00000000 <_ZN3vex6vision6objectaSEl>:
   0:	e3a02000 	mov	r2, #0
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex6vision12takeSnapshotEmm+0x80a5e0>

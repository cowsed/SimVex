...
00000000 <_ZN3vex13electromagnetD1Ev>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <_ZN3vex13electromagnetD1Ev+0x1c>
...
00000000 <_ZN3vex13electromagnetD0Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <_ZN3vex13electromagnetD0Ev>
...
00000000 <_ZN3vex13electromagnet9installedEv>:
...
00000000 <_ZN3vex13electromagnet8setPowerEm>:
...
00000000 <_ZN3vex13electromagnet6pickupEv>:
...
00000000 <_ZN3vex13electromagnet6pickupEdNS_9timeUnitsEl>:
   0:	ec432b30 	vmov	d16, r2, r3
   4:	e59d1004 	ldr	r1, [sp, #4]
   8:	e59d3000 	ldr	r3, [sp]
   c:	eddf1b0b 	vldr	d17, [pc, #44]	; 40 <_ZN3vex13electromagnet6pickupEdNS_9timeUnitsEl+0x40>
  ...
  2c:	1ddf1b05 	vldrne	d17, [pc, #20]	; 48 <_ZN3vex13electromagnet6pickupEdNS_9timeUnitsEl+0x48>
...
00000000 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsEl>:
   0:	ec432b30 	vmov	d16, r2, r3
   4:	e59d1004 	ldr	r1, [sp, #4]
   8:	e59d3000 	ldr	r3, [sp]
   c:	eddf1b0d 	vldr	d17, [pc, #52]	; 48 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsEl+0x48>
  10:	e3510000 	cmp	r1, #0
  14:	b2611000 	rsblt	r1, r1, #0
  18:	e5900008 	ldr	r0, [r0, #8]
  ...
  30:	1ddf1b06 	vldrne	d17, [pc, #24]	; 50 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsEl+0x50>
...
00000000 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsE>:
   0:	e92d4007 	push	{r0, r1, r2, lr}
   4:	e59d1010 	ldr	r1, [sp, #16]
   8:	e58d1000 	str	r1, [sp]
   c:	e5901010 	ldr	r1, [r0, #16]
  10:	e58d1004 	str	r1, [sp, #4]
  14:	ebfffffe 	bl	0 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsE>
  18:	e28dd00c 	add	sp, sp, #12
  1c:	e49df004 	pop	{pc}		; (ldr pc, [sp], #4)

Disassembly of section .text._ZN3vex13electromagnet11temperatureENS_16temperatureUnitsE:

00000000 <_ZN3vex13electromagnet11temperatureENS_16temperatureUnitsE>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	ebfffffe 	bl	0 <vexMagnetTemperatureGet>
  10:	e3540001 	cmp	r4, #1
  14:	0ddf1b05 	vldreq	d17, [pc, #20]	; 30 <_ZN3vex13electromagnet11temperatureENS_16temperatureUnitsE+0x30>
  18:	0ddf2b06 	vldreq	d18, [pc, #24]	; 38 <_ZN3vex13electromagnet11temperatureENS_16temperatureUnitsE+0x38>
...
00000000 <_ZTVN3vex13electromagnetE>:
	...
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex13electromagnet4dropEdNS_9timeUnitsEl+0x80a5e0>

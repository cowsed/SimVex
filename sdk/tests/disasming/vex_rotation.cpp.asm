...
00000000 <_ZN3vex8rotationD1Ev>:
   0:	e59f3014 	ldr	r3, [pc, #20]	; 1c <_ZN3vex8rotationD1Ev+0x1c>
...
00000000 <_ZN3vex8rotationD0Ev>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04000 	mov	r4, r0
   8:	ebfffffe 	bl	0 <_ZN3vex8rotationD0Ev>
...
00000000 <_ZN3vex8rotation9installedEv>:
...
00000000 <_ZN3vex8rotation5angleENS_13rotationUnitsE>:
  ...
  1c:	0a000003 	beq	30 <_ZN3vex8rotation5angleENS_13rotationUnitsE+0x30>
  20:	e3540001 	cmp	r4, #1
  24:	1a000003 	bne	38 <_ZN3vex8rotation5angleENS_13rotationUnitsE+0x38>
  28:	eddf1b04 	vldr	d17, [pc, #16]	; 40 <_ZN3vex8rotation5angleENS_13rotationUnitsE+0x40>
  2c:	ea000000 	b	34 <_ZN3vex8rotation5angleENS_13rotationUnitsE+0x34>
  30:	eddf1b04 	vldr	d17, [pc, #16]	; 48 <_ZN3vex8rotation5angleENS_13rotationUnitsE+0x48>
...
00000000 <_ZN3vex8rotation13resetPositionEv>:
   0:	e5900008 	ldr	r0, [r0, #8]
   4:	e3a01000 	mov	r1, #0
...
00000000 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE>:
   0:	ec432b30 	vmov	d16, r2, r3
   4:	e59d3000 	ldr	r3, [sp]
   8:	e3530000 	cmp	r3, #0
   c:	0a000003 	beq	20 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE+0x20>
  10:	e3530001 	cmp	r3, #1
  14:	1a000003 	bne	28 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE+0x28>
  18:	eddf1b06 	vldr	d17, [pc, #24]	; 38 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE+0x38>
  1c:	ea000000 	b	24 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE+0x24>
  20:	eddf1b06 	vldr	d17, [pc, #24]	; 40 <_ZN3vex8rotation11setPositionEdNS_13rotationUnitsE+0x40>
...
00000000 <_ZN3vex8rotation8positionENS_13rotationUnitsE>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
  ...
  14:	ee070a90 	vmov	s15, r0
  18:	eef80be7 	vcvt.f64.s32	d16, s15
  1c:	0a000003 	beq	30 <_ZN3vex8rotation8positionENS_13rotationUnitsE+0x30>
  20:	e3540001 	cmp	r4, #1
  24:	1a000003 	bne	38 <_ZN3vex8rotation8positionENS_13rotationUnitsE+0x38>
  28:	eddf1b04 	vldr	d17, [pc, #16]	; 40 <_ZN3vex8rotation8positionENS_13rotationUnitsE+0x40>
  2c:	ea000000 	b	34 <_ZN3vex8rotation8positionENS_13rotationUnitsE+0x34>
  30:	eddf1b04 	vldr	d17, [pc, #16]	; 48 <_ZN3vex8rotation8positionENS_13rotationUnitsE+0x48>
  34:	eec00ba1 	vdiv.f64	d16, d16, d17
  38:	ec510b30 	vmov	r0, r1, d16
  3c:	e8bd8010 	pop	{r4, pc}
  40:	00000000 	andeq	r0, r0, r0
...
00000000 <_ZN3vex8rotation8velocityENS_13velocityUnitsE>:
   0:	e92d4010 	push	{r4, lr}
   4:	e1a04001 	mov	r4, r1
   8:	e5900008 	ldr	r0, [r0, #8]
   c:	ebfffffe 	bl	0 <vexAbsEncVelocityGet>
  10:	e3540001 	cmp	r4, #1
  14:	0ddf1b0b 	vldreq	d17, [pc, #44]	; 48 <_ZN3vex8rotation8velocityENS_13velocityUnitsE+0x48>
  18:	ee070a90 	vmov	s15, r0
  1c:	eef80be7 	vcvt.f64.s32	d16, s15
  20:	0a000002 	beq	30 <_ZN3vex8rotation8velocityENS_13velocityUnitsE+0x30>
  24:	e3540000 	cmp	r4, #0
  28:	1a000003 	bne	3c <_ZN3vex8rotation8velocityENS_13velocityUnitsE+0x3c>
  2c:	eef11b08 	vmov.f64	d17, #24	; 0x40c00000  6.0
  30:	ee600ba1 	vmul.f64	d16, d16, d17
  34:	eddf1b05 	vldr	d17, [pc, #20]	; 50 <_ZN3vex8rotation8velocityENS_13velocityUnitsE+0x50>
...
00000000 <_ZN3vex8rotation7changedEPFvvE>:
...
00000000 <.comment>:
  ...
  44:	5b202965 	blpl	80a5e0 <_ZN3vex8rotation8velocityENS_13velocityUnitsE+0x80a5e0>
